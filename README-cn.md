...
MACD、KDJ 金叉、ADX>25、EMA9>EMA21>EMA99时，加仓总资金 2%，KDJ死叉减去加仓数量。

#### 浮亏 DCA 加仓

基于动态平均入场价，跌至 1−(0.01+dca_count×0.02)，且 KDJ_J< 0或RSI< 20或KDJ_J< 20和RSI< 35，加仓总资金 2%，dca_count+1，上限5次，冷却时间60m.

#### 浮盈 TP 加仓

触发浮盈止盈后加仓总资金 5%，tp_count+1。

#### 止盈后回撤减仓

已有 TP（tp_count>0），且持仓浮盈< 1% 以下时，减至总资金 5%，tp_count=0。

#### 分批止盈

已触发 DCA（dca_count>0），止盈时减至总资金 5%， dca_count=0。

未触发TP，止盈时减仓 30%，标记可浮盈加仓。

#### 网格
首次买单为持仓均价的 0.98，后续买单价为成交价的 0.98，加仓总资金 2%，若已触发DCA则只加仓 1%，上限 5次，冷却时间30m；
卖单价为成交价的 1.02，减仓 20%。


### 优点：

24h自动化交易，结合了网格和定投的部分逻辑。

初始资金占用率低，根据总资金加仓，仓位上限25%左右。
